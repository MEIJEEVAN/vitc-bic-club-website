    ...
    <div className="pt-32 pb-20 px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
          ...
          >
            <div className="w-80 h-80 bg-gradient-to-br from-gray-100 to-gray-200 rounded-full flex items-center justify-center shadow-xl">
              <div className="text-center">
                <div className="font-mono text-4xl font-bold text-black mb-2">BIC</div>
                <div className="font-mono text-sm text-gray-600">VIT Chennai</div>
              </div>
            </div>
          </motion.div>
